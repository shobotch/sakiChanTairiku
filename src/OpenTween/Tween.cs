...
namespace OpenTween
{
    public partial class TweenMain : Form
    {
        ...
        private bool _DoFavCopyFlags = false;
    ...
    RETRY:
        ...
        private void doCopy()
        {
            ...
            if (this.ExistCurrentPost)
            {
                ...
                string data = _curPost.Text;
                data = CreateRetweetUnofficial(data);
                StatusText.Text = HttpUtility.HtmlDecode(data);
        ...
        private void FavCopy()
        {
            if (this.ExistCurrentPost && !_curPost.IsDm)
            {
                _DoFavCopyFlags = true;
                FavoriteChange(true);
                if (!_curPost.IsProtect && _DoFavCopyFlags)
                {
                    _DoFavCopyFlags = false;
                    doCopy();
                    DirectPost();
                }
            }
...
#region "Userstream"
        ...
        private void SoundFileTbComboBox_Click(object sender, EventArgs e)
        {

        }

        private void DarkFunctionMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void favCopyOpMenuItem_Click(object sender, EventArgs e)
        {
            FavCopy();
        }

        private void copyOpMenuItem_Click(object sender, EventArgs e)
        {
            Copy();
        }

        private void CopyRetweetOpMenuItem_Click(object sender, EventArgs e)
        {
            CopyRetweet();
        }
        ...
        private void FavCopyRetweetOpMenuItem_Click(object sender, EventArgs e)
        {
            FavCopyRetweet();
        }

        private void CopyEditOpMenuItem_Click(object sender, EventArgs e)
        {
            CopyEdit();
        }
    }
